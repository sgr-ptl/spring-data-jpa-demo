...
public interface StudentRepository extends JpaRepository<Student,Long> {
    ...
    List<Student> findByGaurdianName(String name);
    ...
    @Query(value = "select * from tbl_student where email_address=:emailId",
            nativeQuery = true)
    Student getStudentByEmailAddressNativeNamed(@Param("emailId") String email);

    // modifying using transactional
    ...
    int updateStudentNameByEamilAddress(String studentName , String EmailAddress);
